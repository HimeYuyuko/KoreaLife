...
b);if("undefined"==typeof FormData){var h=makeGuidTagName("----raonk_"),f=function(a){G_xhr&&(G_xhr.setRequestHeader("Content-Type","multipart/form-data; boundary="+h),G_xhr.setRequestHeader("RAONK-Encoded","base64"));c=a;k()};try{buildFormData(a,b,h,f)}catch(l){self.postMessage({type:"error",code:"C001",message:l.message,workerId:a.workerId}),G_xhr=void 0}}else{c=new FormData;c.append(b.name,b.value);var g;if("1"==(""!=a.security.fileIntegrityUpload?a.security.fileIntegrityUpload:a.security.fileIntegrity)||
"0"!=a.compress||"0"!=a.security.fileEncrypt){g=new FileReaderSync;try{f=g.readAsArrayBuffer(a.chunk),g=void 0}catch(m){g=void 0,self.postMessage({type:"error",code:"C009",message:"Http Status Code: "+G_xhr.status,id:a.id}),G_xhr=void 0,self.close()}}b="";if("1"==(""!=a.security.fileIntegrityUpload?a.security.fileIntegrityUpload:a.security.fileIntegrity)){G_LoadSecurityJs||(importScripts("raonkupload.fdi.aes.js"),importScripts("hmac-sha256.js"),G_LoadSecurityJs=!0);try{b=D5FileDataIntegrity(f,a.security.keyValue.substring(0,
11),!0).toString()}catch(n){self.postMessage({type:"error",code:"C009",message:"Http Status Code: "+G_xhr.status,id:a.id}),G_xhr=void 0,self.close()}c.append("k25",b)}var p=function(a){c.append("Slice",a);k()};"0"!=a.compress?makeZipData(a.uploadIdx,f,function(b){0<a.security.fileEncrypt?(g=new FileReaderSync,newData=g.readAsArrayBuffer(b),g=void 0,encryptFileData(newData,a.security.keyValue.substring(0,11),16*a.security.fileEncrypt,p)):(c.append("Slice",b),k())}):0<a.security.fileEncrypt?encryptFileData(f,
a.security.keyValue.substring(0,11),16*a.security.fileEncrypt,p):(c.append("Slice",a.chunk),k())}}self.onmessage=function(a){a=a.data;switch(a.type){case "upload":upload(a.uploadData);break;case "check_formdata":a=!0,"undefined"==typeof FormData&&(a=!1),self.postMessage({type:"check_formdata",isFormDataSupport:a})}};
